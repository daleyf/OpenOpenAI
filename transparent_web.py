...
def ask(question: str, model: str, dev_mode: bool, docs: str) -> Tuple[str, List[dict], dict, str]:
    ...
    return result["output"], result["messages"], result["logprobs"], result["model"]
...
def main() -> None:
    with gr.Blocks() as demo:
        ...
        docs = gr.Textbox(label="RAG Context (optional)", lines=2, placeholder="Paste reference text here")
        ...
        run.click(ask, [question, model, dev, docs], [output, messages, logprobs, used_model])
    demo.launch()
